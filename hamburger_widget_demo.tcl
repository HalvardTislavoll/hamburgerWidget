...
proc vTclWindow.top1 {base} {
    ...
    ttk::frame "$top.tFr47" \
        -borderwidth 2 -relief groove -width 545 -height 355 
    vTcl:DefineAlias "$top.tFr47" "TFrame1" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    set site_3_0 $top.tFr47
    ttk::style configure TFrame -background $vTcl(actual_gui_bg)
    ttk::frame "$site_3_0.tFr47" \
        -borderwidth 2 -relief flat -width 85 -height 335 
    vTcl:DefineAlias "$site_3_0.tFr47" "TfrmMenu" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    place $site_3_0.tFr47 \
        -in $site_3_0 -x 440 -y 20 -width 85 -relwidth 0 -height 332 \
    ...
    ttk::button "$top.tBu48" \
        -command "TButton_Exit" -takefocus {} -text "Exit" -compound left 
    vTcl:DefineAlias "$top.tBu48" "TButton_Exit" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    bind $top.tBu48 <<SetBalloon>> {
        set ::vTcl::balloon::%W {warning! This will close this application}
    }
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.tFr47 \
        -in $top -x 30 -y 20 -width 545 -height 355 -anchor nw \
        -bordermode ignore 
    place $top.tBu48 \
        -in $top -x 490 -y 390 -width 83 -height 28 -anchor nw \
        -bordermode ignore 
